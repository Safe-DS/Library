...
@pytest.mark.parametrize(
    ...
    [("test_table_from_json_file_invalid.json", r"test_table_from_json_file_invalid.json\" does not exist"), (Path("test_table_from_json_file_invalid.json"), r"test_table_from_json_file_invalid.json\" does not exist")],
