...
def test_should_raise_error(
    ...
    with pytest.raises(error, match=error_msg):
        TimeSeries._from_table_to_time_series(table, target_name=target_name, time_name=time_name, feature_names=feature_names)
...
def test_should_create_a_tagged_table(table: Table, target_name: str, time_name: str, feature_names: list[str] | None) -> None:
    time_series = TimeSeries._from_table_to_time_series(table, target_name=target_name, time_name=time_name, feature_names=feature_names)
