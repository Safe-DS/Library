...
class TestFromJpegFile:
    ...
    def test_should_load_jpeg_file(self, resource_path: str | Path) -> None:
        ImagePil.from_jpeg_file(resolve_resource_path(resource_path))
...
class TestFromPngFile:
    ...
    def test_should_load_png_file(self, resource_path: str | Path) -> None:
        ImagePil.from_png_file(resolve_resource_path(resource_path))
...
class TestProperties:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ImagePil.from_png_file(resolve_resource_path("image/plane.png")),
                568,
                320,
            ),
        ],
...
class TestToJpegFile:
    ...
    def test_should_save_jpeg_file_by_str(self, resource_path: str) -> None:
        image = ImagePil.from_jpeg_file(resolve_resource_path(resource_path))
...
class TestToPngFile:
    ...
    def test_should_save_png_file_by_str(self, resource_path: str) -> None:
        image = ImagePil.from_png_file(resolve_resource_path(resource_path))
...
class TestEquals:
    def test_should_be_equal(self) -> None:
        image = ImagePil.from_png_file(resolve_resource_path("image/white_square.png"))
        image2 = ImagePil.from_png_file(resolve_resource_path("image/white_square.png"))
        assert image == image2

    def test_should_not_be_equal(self) -> None:
        image = ImagePil.from_png_file(resolve_resource_path("image/white_square.png"))
        image2 = ImagePil.from_png_file(resolve_resource_path("image/plane.png"))
        assert image != image2
...
class TestFlipVertically:
    ...
    def test_should_be_original_if_flipped_twice(self) -> None:
        original = ImagePil.from_png_file(resolve_resource_path("image/plane.png"))
...
class TestAdjustContrast:
    ...
    def test_should_raise(self) -> None:
        image = ImagePil.from_png_file(resolve_resource_path("image/plane.png"))
...
class TestColorAdjust:
    ...
    def test_should_warn(self, resource_path: str, factor: float) -> None:
        original = ImagePil.from_png_file(resolve_resource_path(resource_path))
        with pytest.warns(
            UserWarning,
