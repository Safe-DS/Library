...
class TestAllImageCombinations:
    ...
    def test_from_files(self, resource_path1: str, resource_path2: str, resource_path3: str) -> None:
        ...
        assert image_list_wo_im_1 == ImageList.from_images([im for im in [image2_with_expected_channel, image3_with_expected_channel] if im != image1_with_expected_channel])
        assert image_list_wo_im_2 == ImageList.from_images([im for im in [image1_with_expected_channel, image3_with_expected_channel] if im != image2_with_expected_channel])
        assert image_list_wo_im_3 == ImageList.from_images([im for im in [image1_with_expected_channel, image2_with_expected_channel] if im != image3_with_expected_channel])
        assert image_list_wo_im_1.remove_image(image2_with_expected_channel) == ImageList.from_images([image3_with_expected_channel] if image3_with_expected_channel not in [image1_with_expected_channel, image2_with_expected_channel] else [])
        assert image_list_wo_im_2.remove_image(image1_with_expected_channel) == ImageList.from_images([image3_with_expected_channel] if image3_with_expected_channel not in [image1_with_expected_channel, image2_with_expected_channel] else [])
        assert image_list_wo_im_1.remove_image(image3_with_expected_channel) == ImageList.from_images([image2_with_expected_channel] if image2_with_expected_channel not in [image1_with_expected_channel, image3_with_expected_channel] else [])
        assert image_list_wo_im_3.remove_image(image1_with_expected_channel) == ImageList.from_images([image2_with_expected_channel] if image2_with_expected_channel not in [image1_with_expected_channel, image3_with_expected_channel] else [])
        assert image_list_wo_im_2.remove_image(image3_with_expected_channel) == ImageList.from_images([image1_with_expected_channel] if image1_with_expected_channel not in [image2_with_expected_channel, image3_with_expected_channel] else [])
        assert image_list_wo_im_3.remove_image(image2_with_expected_channel) == ImageList.from_images([image1_with_expected_channel] if image1_with_expected_channel not in [image2_with_expected_channel, image3_with_expected_channel] else [])
        assert image_list_wo_im_1.remove_image(image2_with_expected_channel).remove_image(image3_with_expected_channel) == _EmptyImageList()
        assert image_list_wo_im_1.remove_image(image3_with_expected_channel).remove_image(image2_with_expected_channel) == _EmptyImageList()
        assert image_list_wo_im_2.remove_image(image1_with_expected_channel).remove_image(image3_with_expected_channel) == _EmptyImageList()
        assert image_list_wo_im_2.remove_image(image3_with_expected_channel).remove_image(image1_with_expected_channel) == _EmptyImageList()
        assert image_list_wo_im_3.remove_image(image1_with_expected_channel).remove_image(image2_with_expected_channel) == _EmptyImageList()
        assert image_list_wo_im_3.remove_image(image2_with_expected_channel).remove_image(image1_with_expected_channel) == _EmptyImageList()
        ...
        assert image_list.remove_images([image1_with_expected_channel, image2_with_expected_channel]) == ImageList.from_images([image3_with_expected_channel] if image3_with_expected_channel not in [image1_with_expected_channel, image2_with_expected_channel] else [])
        assert image_list.remove_images([image1_with_expected_channel, image3_with_expected_channel]) == ImageList.from_images([image2_with_expected_channel] if image2_with_expected_channel not in [image1_with_expected_channel, image3_with_expected_channel] else [])
        assert image_list.remove_images([image2_with_expected_channel, image3_with_expected_channel]) == ImageList.from_images([image1_with_expected_channel] if image1_with_expected_channel not in [image2_with_expected_channel, image3_with_expected_channel] else [])
