...
#     ) -> None:
#         # TODO: test makes no sense like this: an image to image converter should never accept a table as output
#         input_conversion = _ImageToImageConverter(
#             image_dataset_valid.input_size,
#             output_size=image_dataset_valid.output_size,
#         )
