...
input_time_series_dataset = TimeSeriesDataset({"a": [1], "b": [1]}, target_name="a", time_name="b", window_size=1)
...
class TestEq:
    @pytest.mark.parametrize(
        ...
        [
            (
                _TimeSeriesConverter(input_time_series_dataset, 1, 1),
                _TimeSeriesConverter(input_time_series_dataset, 1, 1),
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                _TimeSeriesConverter(input_time_series_dataset, 1, 1, prediction_name="2"),
                _TimeSeriesConverter(input_time_series_dataset, 1, 1, prediction_name="1"),
            ),
        ],
    )
...
class TestHash:
    ...
    def test_hash_should_not_be_equal(self) -> None:
        output_conversion_ts1 = _TimeSeriesConverter(input_time_series_dataset, 1, 1, prediction_name="1")
        output_conversion_ts2 = _TimeSeriesConverter(input_time_series_dataset, 1, 1, prediction_name="2")
        output_conversion_ts3 = _TimeSeriesConverter(input_time_series_dataset, 1, 1, prediction_name="3")
...
class TestSizeOf:
    @pytest.mark.parametrize(
        ...
        [
            _TimeSeriesConverter(input_time_series_dataset, 1, 1, prediction_name="1"),
            _TimeSeriesConverter(input_time_series_dataset, 1, 1, prediction_name="2"),
            _TimeSeriesConverter(input_time_series_dataset, 1, 1, prediction_name="3"),
        ],
    )
