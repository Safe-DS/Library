...
class TestDataConversionImage:
    ...
    class TestEq:
        ...
        def test_should_be_equal(self, output_conversion_image1: _OutputConversionImage, output_conversion_image2: _OutputConversionImage) -> None:
    ...
    class TestHash:
        ...
        def test_hash_should_be_equal(self, output_conversion_image1: _OutputConversionImage, output_conversion_image2: _OutputConversionImage) -> None:
    ...
    class TestSizeOf:
        ...
        def test_should_size_be_greater_than_normal_object(self, output_conversion_image: _OutputConversionImage) -> None:
