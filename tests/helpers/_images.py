...
test_images_folder = Path("image")

plane_jpg_path = str(test_images_folder / "plane.jpg")
plane_png_path = str(test_images_folder / "plane.png")
rgba_png_path = str(test_images_folder / "rgba.png")
white_square_jpg_path = str(test_images_folder / "white_square.jpg")
white_square_png_path = str(test_images_folder / "white_square.png")
grayscale_jpg_path = str(test_images_folder / "grayscale.jpg")
grayscale_png_path = str(test_images_folder / "grayscale.png")
