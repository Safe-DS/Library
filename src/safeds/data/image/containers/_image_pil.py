...
class ImagePil:
    ...
    @staticmethod
    def from_jpeg_file(path: str | Path) -> ImagePil:
        """
    ...
    @staticmethod
    def from_png_file(path: str | Path) -> ImagePil:
        """
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        """
        if not isinstance(other, ImagePil):
    ...
    def resize(self, new_width: int, new_height: int) -> ImagePil:
        """
    ...
    def convert_to_grayscale(self) -> ImagePil:
        """
    ...
    def crop(self, x: int, y: int, width: int, height: int) -> ImagePil:
        """
    ...
    def flip_vertically(self) -> ImagePil:
        """
    ...
    def flip_horizontally(self) -> ImagePil:
        """
    ...
    def adjust_brightness(self, factor: float) -> ImagePil:
        """
    ...
    def add_gaussian_noise(self, standard_deviation: float) -> ImagePil:
        """
    ...
    def adjust_contrast(self, factor: float) -> ImagePil:
        """
    ...
    def adjust_color_balance(self, factor: float) -> ImagePil:
        """
    ...
    def blur(self, radius: int) -> ImagePil:
        """
    ...
    def sharpen(self, factor: float) -> ImagePil:
        """
    ...
    def invert_colors(self) -> ImagePil:
        """
    ...
    def rotate_right(self) -> ImagePil:
        """
