...
class _LazyCell(ExperimentalPolarsCell[T]):
    """
    ...
    @staticmethod
    def _from_polars_expression(expression: pl.Expr) -> _LazyCell:
        result = object.__new__(_LazyCell)
...
def _wrap(other: pl.Expr) -> Any:
    return _LazyCell._from_polars_expression(other)
