...
class _TimeSeriesConverter(_Converter[Table, Column]):
    ...
    def __init__(
        ...
        *,
        ...
        self._target_name: str = input_data.target.name
        self._time_name: str = input_data.time.name
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, _TimeSeriesConverter):
            return False
        return self._prediction_name == other._prediction_name  # TODO: use other attributes

    def __hash__(self) -> int:
        return _structural_hash(self.__class__.__name__ + self._prediction_name)  # TODO: use other attributes

    def __sizeof__(self) -> int:
        return sys.getsizeof(self._prediction_name)  # TODO: use other attributes
    ...
    def _data_conversion_output(
        ...
        return input_data_table.remove_columns(self._target_name).add_columns(
