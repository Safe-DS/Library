...
class _ImageToColumnConverter(_ImageConverter[Column]):
    ...
    def __init__(self, input_data: ImageDataset[Column], is_for_classification: bool) -> None:
        ...
        self._output_size = len(input_data._output._one_hot_encoder._get_names_of_added_columns())
