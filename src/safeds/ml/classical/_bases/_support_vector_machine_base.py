...
class _SupportVectorMachineBase(ABC):
    ...
    def __init__(
        ...
        kernel: _SupportVectorMachineBase.Kernel | Choice[_SupportVectorMachineBase.Kernel] | None,
    ) -> None:
        if kernel is None:
        ...
        self._kernel: _SupportVectorMachineBase.Kernel | Choice[_SupportVectorMachineBase.Kernel] = kernel
    ...
    @property
    @abstractmethod
    def kernel(self) -> _SupportVectorMachineBase.Kernel | Choice[_SupportVectorMachineBase.Kernel]:
