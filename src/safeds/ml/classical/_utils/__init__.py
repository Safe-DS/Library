...
if TYPE_CHECKING:
    from ._fit_sklearn_model_in_place import _fit_sklearn_model_in_place
    from ._predict_with_sklearn_model import _predict_with_sklearn_model

apipkg.initpkg(
    __name__,
    {
        "_fit_sklearn_model_in_place": "._fit_sklearn_model_in_place:_fit_sklearn_model_in_place",
